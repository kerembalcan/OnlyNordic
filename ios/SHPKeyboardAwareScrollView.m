...
@interface SHPScrollEvent : NSObject <RCTEvent>
...
- (SHPScrollEvent *)coalesceWithEvent:(SHPScrollEvent *)newEvent
{
 ...
 */
@interface SHPKeyboardAwareCustomScrollView : UIScrollView<UIGestureRecognizerDelegate>
...
@implementation SHPKeyboardAwareCustomScrollView
...
- (UIView *)contentView
{
  UIView *contentView = ((SHPKeyboardAwareScrollView *)self.superview).contentView;
  /**
  NSLayoutConstraint *bottom =[NSLayoutConstraint
                               ...
                               multiplier:1.0f
                               constant:0.f];
  [SHPKeyboardAwarenessObserver observeView:contentView verticalConstraint:bottom conflictingViewPadding:20];
...
{
  if ([self _shouldDisableScrollInteraction] && ![[RCTUIManager JSResponder] isKindOfClass:[SHPKeyboardAwareScrollView class]]) {
...
@implementation SHPKeyboardAwareScrollView
{
  RCTEventDispatcher *_eventDispatcher;
  SHPKeyboardAwareCustomScrollView *_scrollView;
  UIView *_contentView;
...
- (instancetype)initWithEventDispatcher:(RCTEventDispatcher *)eventDispatcher
{
  ...
  if ((self = [super initWithFrame:CGRectZero])) {
    ...
    _scrollView = [[SHPKeyboardAwareCustomScrollView alloc] initWithFrame:CGRectZero];
...
#endif
  {
    RCTAssert(_contentView == nil, @"SHPKeyboardAwareScrollView may only contain a single subview");
    _contentView = view;
                       ...
                       userData:(NSDictionary *)userData
{
  ...
  SHPScrollEvent *scrollEvent = [[SHPScrollEvent alloc] initWithEventName:eventName
...
@implementation RCTEventDispatcher (SHPKeyboardAwareScrollView)
...
- (void)sendFakeScrollEvent:(NSNumber *)reactTag
{
  ...
  SHPScrollEvent *fakeScrollEvent = [[SHPScrollEvent alloc] initWithEventName:eventName
                                                                     reactTag:reactTag
