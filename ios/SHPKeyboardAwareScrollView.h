...
@class SHPKeyboardAwarenessObserver;
@protocol UIScrollViewDelegate;
@interface SHPKeyboardAwareScrollView : RCTView <UIScrollViewDelegate, RCTScrollableProtocol, RCTAutoInsetsProtocol>

- (instancetype)initWithEventDispatcher:(RCTEventDispatcher *)eventDispatcher NS_DESIGNATED_INITIALIZER;

/**
 * The `SHPKeyboardAwareScrollView` may have at most one single subview. This will ensure
...
@interface SHPKeyboardAwareScrollView (Internal)

- (void)updateContentOffsetIfNeeded;

@end

@interface RCTEventDispatcher (SHPKeyboardAwareScrollView)
