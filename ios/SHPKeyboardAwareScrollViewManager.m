//
//  SHPKeyboardAwareScrollViewManager.m
//  CoolStuff
//
...
#import "SHPKeyboardAwareScrollViewManager.h"
...
@interface SHPKeyboardAwareScrollView (Private)
...
@implementation SHPKeyboardAwareScrollViewManager

RCT_EXPORT_MODULE()

- (UIView *)view
{
  return [[SHPKeyboardAwareScrollView alloc] initWithEventDispatcher:self.bridge.eventDispatcher];
}
                  ...
                  callback:(RCTResponseSenderBlock)callback)
{
  [self.bridge.uiManager addUIBlock:
   ^(__unused RCTUIManager *uiManager, NSDictionary<NSNumber *, SHPKeyboardAwareScrollView *> *viewRegistry) {
     
     SHPKeyboardAwareScrollView *view = viewRegistry[reactTag];
     if (!view || ![view isKindOfClass:[SHPKeyboardAwareScrollView class]]) {
       RCTLogError(@"Cannot find SHPKeyboardAwareScrollView with tag #%@", reactTag);
       return;
     }
