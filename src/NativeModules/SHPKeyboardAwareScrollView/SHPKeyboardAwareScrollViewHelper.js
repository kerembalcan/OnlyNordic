 ...
 *
 * @providesModule SPHKeyboardAwareScrollViewHelper
 * @flow
 */
'use strict';
...
/**
 * Component that wraps platform SPHKeyboardAwareScrollViewHelper while providing
 * integration with touch locking "responder" system.
 *
 * Keep in mind that ScrollViews must have a bounded height in order to work,
 * since they contain unbounded-height children into a bounded container (via
 * a scroll interaction). In order to bound the height of a SPHKeyboardAwareScrollViewHelper, either
 ...
 *
 *
 * `<SPHKeyboardAwareScrollViewHelper>` vs [`<FlatList>`](/react-native/docs/flatlist.html) - which one to use?
 *
 * `SPHKeyboardAwareScrollViewHelper` simply renders all its react child components at once. That
...
const SPHKeyboardAwareScrollViewHelper = createReactClass({
  ...
  propTypes: {
     ...
     * ```
     * return (
     *   <SPHKeyboardAwareScrollViewHelper contentContainerStyle={styles.contentContainer}>
     *   </SPHKeyboardAwareScrollViewHelper>
     * );
     * ...
    ...
    /**
     * When true, the SPHKeyboardAwareScrollViewHelper will try to lock to only vertical or horizontal
    ...
    /**
     * Called when the momentum scroll starts (scroll which occurs as the SPHKeyboardAwareScrollViewHelper glides to a stop).
     */
    onMomentumScrollBegin: PropTypes.func,
    /**
     * Called when the momentum scroll ends (scroll which occurs as the SPHKeyboardAwareScrollViewHelper glides to a stop).
     */
    ...
    /**
     * Called when scrollable content view of the SPHKeyboardAwareScrollViewHelper changes.
     *
     * Handler function is passed the content width and content height as parameters:
     * `(contentWidth, contentHeight)`
     *
     * It's implemented using onLayout handler attached to the content container
     * which this SPHKeyboardAwareScrollViewHelper renders.
     */
    ...
    /**
     * When true, SPHKeyboardAwareScrollViewHelper allows use of pinch gestures to zoom in and out.
     * The default value is true.
     * @platform ios
     */
     ...
     * functionality for the SPHKeyboardAwareScrollViewHelper. Only works for vertical ScrollViews
    ...
    /**
     * When true, SPHKeyboardAwareScrollViewHelper will emit updateChildFrames data in scroll events,
  ...
  /**
   * If this is a vertical SPHKeyboardAwareScrollViewHelper scrolls to the bottom.
   * If this is a horizontal SPHKeyboardAwareScrollViewHelper scrolls to the right.
   *
  ...
  render: function() {
    ...
    if (refreshControl) {
      if (Platform.OS === 'ios') {
        // On iOS the RefreshControl is a child of the SPHKeyboardAwareScrollViewHelper.
        ...
        // On Android wrap the SPHKeyboardAwareScrollViewHelper with a AndroidSwipeRefreshLayout.
        // Since the SPHKeyboardAwareScrollViewHelper is wrapped add the style props to the
        // AndroidSwipeRefreshLayout and use flex: 1 for the SPHKeyboardAwareScrollViewHelper.
        // Note: we should only apply props.style on the wrapper
        // however, the SPHKeyboardAwareScrollViewHelper still needs the baseStyle to be scrollable
